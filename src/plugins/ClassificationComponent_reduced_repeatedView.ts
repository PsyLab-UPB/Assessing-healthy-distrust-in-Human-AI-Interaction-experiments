...
const info = {
    name: "classification-component-repeatedView",
    parameters: {
        play_feedback:{
       ...
       /* likert_prompt:{
        ...
        clssfctn:{
            type: ParameterType.HTML_STRING,
            pretty_name: "Classification shown",
            default: undefined, 
        },
        image1:{
...
class ClassificationComponent {
    ...
    trial(display_element, trial) {
        ...
        let imageLeft = trial.image1;
        //let imageRight;
        let alphaLeft = 1;
        //let alphaRight;
        let borderLeft = "border: 5px solid #000000";
        //let borderRight;
        /* if(trial.probeLeft) {
        ...
        <img id="ToBeClassified1" src="`+imageLeft+`" style="opacity:`+alphaLeft+`; `+borderLeft+`; width:440px; visibility:hidden" >
        <div id="shownPrompt" style="visibility:hidden">`+trial.category_prompt+`</div>
        <button style="width:200px; height: 50px; visibility:hidden" id="CategoryA">`+trial.category_Names[0].categoryName+`</button>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button style="width:200px; height: 50px; visibility:hidden" id="CategoryB"/>`+trial.category_Names[1].categoryName+`</button></br>    
        `;
        // tryOut
        ...
        (new Promise((res) => {
            ...
            //setTimeout(() => {res(category)}, 250);
             ...
             // set Timeout
            var time_left = 3; // time to answer in seconds, change here for shorter/longer time
