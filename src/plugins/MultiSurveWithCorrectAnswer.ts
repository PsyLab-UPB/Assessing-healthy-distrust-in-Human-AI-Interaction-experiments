...
const info = {
    name: "survey-multi-choice-correct",
    parameters: {
        ...
        questions: {
            ...
            nested: {
                ...
                AnswerAssociatedInformation: {
                    type: ParameterType.STRING,
                    pretty_name: "Answer Associated Information",
                    default: "",
                },
            },
        },
 ...
 */
class MultiSurveWithCorrectAnswer {
    private jsPsych
    public static info
    constructor(jsPsych) {
    ...
    trial(display_element, trial) {
        var plugin_id_name = "jspsych-survey-multi-choice-correct";
        var html = "";
        ...
        document.querySelector("form").addEventListener("submit", (event) => {
            ...
            var answer_data = {}
            var wasCorrect_data = {}
            var answer_associated_information = {}
            for (var i = 0; i < trial.questions.length; i++) {
                ...
                obje[name] = val;
                obja[name] = trial.questions[i].correctAnswer
                objc[name] = trial.questions[i].correctAnswer == val
                obji[name] = trial.questions[i].AnswerAssociatedInformation
                Object.assign(question_data, obje);
                Object.assign(answer_data, obja);
                Object.assign(wasCorrect_data, objc);
                Object.assign(answer_associated_information,obji)
            }
            // save data
            var trial_data = {
                AnswerAssociatedInformation: answer_associated_information,
                wasCorrect: wasCorrect_data,
...
MultiSurveWithCorrectAnswer.info = info;

export { MultiSurveWithCorrectAnswer as default };